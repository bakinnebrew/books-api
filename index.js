...
const app = express();
const BooksRouter = require('./book_routes.js');
const UsersRouter = require('./user_routes.js')
...
app.use('/api/books/add', BooksRouter)
app.use('/api/users/add', UsersRouter)
app.use('/api/books/edit/:id', BooksRouter)
app.use('/api/books/checkout/:id', BooksRouter)
app.use('/api/users/:id', UsersRouter)
app.use('/api/users/checkout/:id', UsersRouter)
app.use('/api/books/checkedout/:id', BooksRouter)
app.use('/api/books/turn_in/:id', BooksRouter)
app.use('/api/users/delete/:id', UsersRouter)
app.use('api/books/delete/:id', BooksRouter)
